...
<header>
    <nav class="navbar navbar-default">
        <div class="nav-container">
                ...
                <div class="nav-top">
                    <div class="nav-top-x">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand hide show-xs" href="{:front_link('Index/index')}"><img src="/static/front/images/logo.png" width="180" height="140" alt=""/></a> 
                        ...
                        <form class="navbar-form navbar-right search" action="{:front_link('Category/search')}">
                            <div class="form-group">
                                <input type="text" class="form-control" name="keyword" value="{:isset($keyword)?$keyword:''}" placeholder="Search">
                            </div>
                    ...
                    <div class="web-logo hidden-xs"> <a href="{:front_link('Index/index')}"><img src="/static/front/images/logo.png" alt="Kiss-Silver"/></a> </div>
                </div>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <div class="navbar-header hidden show-xs">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
                    <a class="navbar-brand hide show-xs" href="#"><img src="/static/front/images/logo.png" width="180" height="140" alt=""/></a> </div>
            ...
            <a class="nav-link" id="sub-drown{:$cate['catid']}" href="{:front_link('Category/index', ['catid' => $cate['catid']])}" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> 
            ...
            <svg class="icon" aria-hidden="true">
                <use xlink:href="{:$cate['icon']}"></use>
                        ...
                        <div class="nav-drown sun-drown dropdown-menu" aria-labelledby="sub-drown{:$cate['catid']}" >
                            <div class="wap-open">{:$cate['catname']} <button class="pull-right btn btn-default" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="iconfont icon-guanbi"></i></button></div>
                            <div class="row no-gutter">
                                <?php
                                foreach($headerCates[$cate["catid"]] as $sk => $scate) {
                                ?>
                                <dl class="col-xs-12 col-md-12">
                                <dt><a href="{:front_link('Category/index', ['catid' => $scate['catid']])}">{:$scate['catname']}<i>·{:$scate['en_catname']}</i></a></dt>
                                ...
                                ?>
                                <dd><a href="{:front_link('Category/index', ['catid' => $sscate['catid']])}">{:$sscate['catname']}<i>·{:$sscate['en_catname']}</i></a></dd>
                                    <?php } } ?>
                                </dl>
                                <?php } ?>
                            </div>
