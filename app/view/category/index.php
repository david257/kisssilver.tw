...
<div class="index-box"> {include file="public/header" /}
  <section class="location hide-xs">
    <div class="location-bg" style="background-image:url({:empty($category['cat_banner'])?'/static/front/images/PLP-CAMELIA-2880x900.jpg':showfile($category['cat_banner'])});">
      <div class="container-fluid">
        <div class="location-txt"> <a href="{:front_link('Index/index')}">首頁</a>
          <?php
                    ...
                    ?>
          .<a href="{:front_link('Category/index', ['catid' => $category['catid']])}">{:$category['catname']}</a>
          <?php } else { ?>
  ...
  <section class="location show-xs">
    <div class="location-bg" style="background-image:url({:empty($category['cat_banner_xs'])?'/static/front/images/PLP-CAMELIA-2880x900.jpg':showfile($category['cat_banner_xs'])});">
      <div class="container-fluid">
        <div class="location-txt"> <a href="{:front_link('Index/index')}">首頁</a>
          <?php
                    if(!empty($breadcrumbs)) {
    ...
    <div class="container-fluid">
      ...
      <div class="products-nav " id="products-nav" >
        <div class="wap-open">商品篩選
          <button class="pull-right btn btn-default" type="button" data-toggle="collapse" data-target="#products-nav" aria-controls="sub-drown" aria-expanded="false" aria-label="Toggle navigation" ><i class="iconfont icon-guanbi"></i></button>
        </div>
        <div class="products-nav-top"> <span class="pull-left"><a>商品篩選</a></span><span class="pull-right"><a href="{:front_link('Category/index', ['catid' => $category['catid']])}">清除所有</a><a href="javascript:void();"><i class="fa fa-close"></i></a></span> </div>
        <ul class="list-nav">
          <li class="list-dropdown"> <a class="list-dropdown-toggle"> 商品排序 <span class="fa fa-angle-down"></span> </a>
              ...
              <div class="link-check">
                <ul>
                  <?php
                                    ...
                                    ?>
                  <li><a href="{:front_link('Category/index', ['catid' => $category['catid'], 'filter' => $_filter, 'sortby' => 'create_at.desc'])}">最新</a></li>
                  <li><a href="{:front_link('Category/index', ['catid' => $category['catid'], 'filter' => $_filter, 'sortby' => 'prod_price.desc'])}">上架時間<i>新-舊</i></a></li>
                  <li><a href="{:front_link('Category/index', ['catid' => $category['catid'], 'filter' => $_filter, 'sortby' => 'prod_price.desc'])}">上架時間<i>舊-新</i></a></li>
                  <li><a href="{:front_link('Category/index', ['catid' => $category['catid'], 'filter' => $_filter, 'sortby' => 'prod_price.desc'])}">價格<i>高-低</i></a></li>
                  <li><a href="{:front_link('Category/index', ['catid' => $category['catid'], 'filter' => $_filter, 'sortby' => 'prod_price.asc'])}">價格<i>低-高</i></a></li>
                  <li><a href="{:front_link('Category/index', ['catid' => $category['catid'], 'filter' => $_filter, 'sortby' => 'sold_qty.desc'])}">銷售量<i>高-低</i></a></li>
                </ul>
              </div>
            </ul>
          </li>
          <li class="list-dropdown"> <a class="list-dropdown-toggle"> 產品分類 <span class="fa fa-angle-down"></span> </a>
            <ul class="list-dropdown-menu">
              <div class="link-check">
                <ul>
                  <?php
                                    ...
                                    ?>
                  <li><a href="{:front_link('Category/index', ['catid' => $subcate['catid']])}">{:$subcate['catname']}<i>[{:isset($catItems[$subcate['catid']])?$catItems[$subcate['catid']]:0}]</i></a></li>
                  <?php } } ?>
                </ul>
              </div>
            </ul>
          ...
          <?php
                    ...
                    ?>
          <li class="list-dropdown"> <a class="list-dropdown-toggle"> {:$attrInfo['title']} <span class="fa fa-angle-down"></span> </a>
                ...
                <ul>
                  ...
                  <li>
                    <?php
                                        ...
                                        ?>
                    <a href="{:front_link('Category/index', ['catid' => $category['catid'], 'filter' => $_filter])}"><i class="glyphicon {$class}"></i> {:$voption['name']} <i>{:isset($attrItems[$voption["valueid"]])?$attrItems[$voption["valueid"]]:0}</i></a> </li>
                  <?php } ?>
                </ul>
              </div>
            </ul>
