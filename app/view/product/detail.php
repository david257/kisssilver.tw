        ...
        <div class="detail-top row no-gutters " >
                ...
                <div class="detail-pic ">
                    <div id="detail" class="slider-pro detail-p">
                        <div class="sp-slides" id="original">
                            ...
                            ?>
                            <div class="sp-slide">
                                <img class="sp-image" src="/static/front/css/images/blank.gif" data-original="{:showfile($image['image_std'])}"  data-src="{:showfile($image['image_std'])}" data-retina="{:showfile($image['image_file'])}"/>
                            </div>
                            <?php } } ?>
            ...
            <div class="col-xs-12 col-md-4 white">
                <div class="detail-content">
                    ...
                    <div class="ps-price"><span class="ps-price-red">特價 <i id="PriceShow">{:price_label($product)}</i></span><span class="ps-price-up">{:price_label_list($product)}</span></div>
                    ...
                    <div class="ps-select row no-gutter">
                        ...
                        <div class="ps-btn row col-xs-12 col-md-12 no-gutter">
                            <div class="col-xs-9 col-md-9">
                                <div class="detail-cart"><button id="AddtoCart" class="detail-cart-btn">加入購物車<svg class="icon" aria-hidden="true">
                                            <use xlink:href="#icon-ziyuan"></use>
                                        </svg></button></div>
                            </div>
                            <div class="col-xs-3 col-md-3">
                                <div href="{:front_link('Wishlist/add', ['prodid' => $product['prodid']])}" class="AjaxTodo detail-love"><button class="detail-love-btn {:in_array($product['prodid'], $wishlists)?'active':''}"><svg class="icon" aria-hidden="true">
                        ...
                        ?>
                        <div class="ps-size"><a href="javascript:void" class="size-btn"  data-toggle="modal" data-target="#myModal{$page['pageid']}"><i class="iconfont icon-gouwuche1"></i> {$page['title']}</a></div>
                        <div class="modal fade modal-detail" id="myModal{$page['pageid']}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel{$page['pageid']}">
                        ...
                        <div class="item">
                            <div class="list-one">
                                <div class="list-pic"><a href="{:front_link('Product/detail', ['prodid' => $prod['prodid']])}">
                                        ...
                                        if(!empty($video)) {
                                            ?>
                                            <video controls onmouseover="this.play()" poster="{:showfile($prod['video_image'])}" onmouseout="this.pause()"><source src="{:showfile($video)}" type="video/mp4"></video>
                                        <?php } else { ?>
...
<script>
    ...
    $('.goods_attr li').click(function(){
        ...
        if($(this).hasClass('active')){
            ...
            if($(this).parent().find("img").length>0) {
                if ($(this).find("img").length > 0) {
                    $("#attrimage").html('<img src="' + $(this).find("img").attr("src") + '" data-original="' + $(this).find("img").attr("src") + '"  data-src="' + $(this).find("img").attr("src") + '" data-retina="' + $(this).find("img").attr("src") + '"/>');
                    $(".sp-slide").hide();
