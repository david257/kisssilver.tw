...
<div class="index-box">
    ...
    <?php foreach ($header_banners as $banner) { ?>
        <a target="_blank" href="{:$banner['url']}">
                        ...
                        <?php } else { ?>
                    	<img alt="{:$banner['title']}" class="sp-image" src="{:showfile($banner['imagefile'])}" data-src="{:showfile($banner['imagefile'])}" data-small="{:showfile($banner['min_imagefile'])}"  data-medium="{:showfile($banner['min_imagefile'])}" data-large="{:showfile($banner['min_imagefile'])}"/>
                        <?php } ?>
                    </a>
        <?php } ?>
