                                ...
                                <div class="col-xs-8 col-sm-8 col-md-10">
                                    <div class="row">
                                        <div class="cart-content col-xs-12 col-sm-8 col-md-8 row no-gutter">
                                            ...
                                            ?>
                                            <p class="col-xs-12">{:$voption['attrname']}：<i>{:$voption['valuename']}</i></p>
                                            <?php } } ?>
                                        ...
                                        <div class="cart-num justify-lg justify-md text-md-right text-sm-right col-xs-12  col-sm-4 col-md-4">
                                            ...
                                            <div class="cart-number pull-right">
                                                <input type="text" data-cartid="{$cartId}" value="{:$prod['qty']}" class="cartqty spinnerExample value"/>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-12 cart-set">
                                            <ul>
                                                <li><a class="AjaxTodo" href="{:front_link('Cart/delete', ['cartId' => $cartId])}" data-toggle="modal" data-target="#delete-shop"><svg class="icon" aria-hidden="true">
                                                            <use xlink:href="#icon-icon_huabanfuben"></use>
                                                        </svg>刪除</a></li>
                                                <li><a href="javascript:void();" onclick="get_prod_data('{$cartId}', {$prod['prodid']})" data-toggle="modal" data-target="#edit-shop"><svg class="icon" aria-hidden="true">
...
<div class="cart-send">
                ...
                <!-- Modal -->
                <div class="modal fade modal-detail" id="size" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            ...
                                            <div class="gl-table__container">
                                                <div class="gl-table__fixed-columns">
                                                    <table class="gl-table__side-labels">
                                                        <tbody>
                                                        <tr>
                                                            <td class="gl-table__label"><span>Product label</span></td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <div class="gl-table__scrollable-columns">
                                                    <table class="gl-table gl-table--scrollable">
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <td colspan="1"><span class="gl-table__content">XS 30/32 | 32/34</span></td>
                                                            <td colspan="1"><span class="gl-table__content">S 34/36 | 36/38</span></td>
                                                            <td colspan="1"><span class="gl-table__content">M 38/40 | 40/42</span></td>
                                                            <td colspan="1"><span class="gl-table__content">L 42/44 | 44/46</span></td>
                                                            <td colspan="1"><span class="gl-table__content">XL 46/48 | 48/50</span></td>
                                                            <td colspan="1"><span class="gl-table__content">2XL 50/52 | 52/54</span></td>
                                                            <td colspan="1"><span class="gl-table__content">3XL 54/56 | 56/58</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="1"><span class="gl-table__content">31 - 33"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">34 - 37"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">37 - 40"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">40 - 44"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">44 - 48"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">48 - 52"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">53 - 58"</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="1"><span class="gl-table__content">27 - 29"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">30 - 32"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">32 - 35"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">35 - 39"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">39 - 43"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">43 - 47"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">48 - 53"</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="1"><span class="gl-table__content">32 - 34"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">35 - 37"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">37 - 40"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">40 - 44"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">44 - 48"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">48 - 51"</span></td>
                                                            <td colspan="1"><span class="gl-table__content">51 - 56"</span></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
            ...
            <div class="owl-carousel">
                ...
                if(!empty($viewed_items)) {
                    foreach($viewed_items as $prod) {
                        ...
                        <div class="item">
                            <div class="list-one">
                                <div class="list-pic"><a href="{:front_link('Product/detail', ['prodid' => $prod['prodid']])}"><img src="{$image}" onMouseOver="javascript:this.src='{$image2}'" onMouseOut="javascript:this.src='{$image}'" alt=""/></a></div>
...
<script>
    function get_prod_data(cartId, prodid) {
        $.getJSON('{:front_link("Product/editCart")}', {prodid:prodid, cartId:cartId}, function(json) {
            if(json.code>0) {
                layer.msg(json.msg);
            } else {
...
<script>
    ...
    $("#CheckoutBtn").click(function() {
        ...
        //set shipping type
        $.ajax({
            url: "{:front_link('Cart/setLogisticsType')}",
            type: "post",
            dataType: "json",
            data: {LogisticsType:$("input[name=LogisticsType]:checked").val()},
            success: function (json) {
                if(json.code) {
                    layer.msg(json.msg);
                    return false;
