...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">訂閱列表</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{:admin_link('Index/index')}">首頁</a></li>
                        <li class="breadcrumb-item active">訂閱列表</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card">
            <div class="card-body">
                <p><a href="{:admin_link('index', ['export' => 1])}" class="btn btn-primary bg-primary">匯出</a></p>
                <div class="alert alert-info">訂閱郵件群發請匯出後借用第三方專業的群發工具，效率更好，到達率更高</div>
                <div id="jsGrid1" class="jsgrid" style="position: relative; height: 100%; width: 100%;"><div class="jsgrid-grid-header jsgrid-header-scrollbar">
                        <table class="jsgrid-table">
                            <tr class="jsgrid-header-row">
                                ...
                                <th class="jsgrid-header-cell">訂閱日期</th>
                            ...
                            ?>
                            <tr class="jsgrid-row">
                                <td class="jsgrid-cell">{:$v['email']}</td>
                                <td class="jsgrid-cell">{:date('Y-m-d',$v['create_at'])}</td>
                                <td class="jsgrid-cell">
                                    <a class="AjaxTodo" href="{:admin_link('delete', ['email' => $v['email']])}">刪除</a>
                                </td>
                            </tr>
                            <?php } } ?>
                        </table>
