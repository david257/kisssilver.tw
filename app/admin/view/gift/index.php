...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">贈品列表</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{:admin_link('Index/index')}">首頁</a></li>
                        <li class="breadcrumb-item active">贈品列表</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card">
            <div class="card-body">
                <p><a href="{:admin_link('Gift/add')}" class="btn btn-primary bg-primary">新增</a></p>
                <div id="jsGrid1" class="jsgrid" style="position: relative; height: 100%; width: 100%;"><div class="jsgrid-grid-header jsgrid-header-scrollbar">
                        <table class="jsgrid-table">
                            <tr class="jsgrid-header-row">
                                ...
                                <th class="jsgrid-header-cell">贈品名稱</th>
                                <th class="jsgrid-header-cell">庫存</th>
                            ...
                            <tr class="jsgrid-row">
                                ...
                                <td class="jsgrid-cell">{:$v['prodname']}</td>
                                <td class="jsgrid-cell">{:$v['stock']}</td>
                                <td class="jsgrid-cell">{:get_states($v['state'])}</td>
                                <td class="jsgrid-cell">
                                    <a href="{:admin_link('edit', ['giftid' => $v['giftid']])}">編輯</a>
                                    <a class="AjaxTodo" href="{:admin_link('delete', ['giftid' => $v['giftid']])}">刪除</a>
                                </td>
                            </tr>
                            <?php } } ?>
                        </table>
