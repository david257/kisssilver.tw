...
$(".checkboxAll input").click(function () {
  if (isCheckAll) {
...
$(".cart-box .checkbox input").click(function () {
  var allcheckbox = $(".checkbox").length;
  var allcheckboxs = $(".checkbox input[type='checkbox']:checked").length;
  if (allcheckboxs < allcheckbox) {
    $(".checkboxAll input[type='checkbox']").attr("checked", false);
  } else {
    $(".checkboxAll input[type='checkbox']").attr("checked", true);
  }
});
