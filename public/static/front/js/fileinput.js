...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div class="file-caption form-control {class}" tabindex="500">\n' +
                ...
                '  <input class="file-caption-name form-control" onkeydown="return false;" onpaste="return false;">\n' +
                '</div>';
            //noinspection HtmlUnknownAttribute
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="iconfont icon-shanchu1"></i>',
                    removeClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="iconfont icon-shangchuantupian"></i>',
                    ...
                    zoomIcon: '<i class="iconfont icon-souxun"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="iconfont icon-icon-left"></i>',
            next: '<i class="iconfont icon-right"></i>',
            toggleheader: '<i class="iconfont icon-icon11"></i>',
            fullscreen: '<i class="iconfont icon-fangda"></i>',
            borderless: '<i class="iconfont icon-quanping"></i>',
            close: '<i class="iconfont icon-quxiao"></i>'
        },
        ...
        browseIcon: '<i class="iconfont icon-fujianguanli-xuanzetupian"></i>&nbsp;',
        browseClass: 'btn btn-primary btn-lg',
        removeIcon: '<i class="iconfont icon-shanchu1"></i>',
        removeClass: 'btn btn-default btn-secondary btn-lg',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn btn-default btn-secondary btn-lg',
        pauseIcon: '<i class="glyphicon glyphicon-pause"></i>',
        pauseClass: 'btn btn-default btn-secondary btn-lg',
        uploadIcon: '<i class="iconfont icon-shangchuantupian"></i>',
        uploadClass: 'btn btn-default btn-secondary btn-lg',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadParamNames: {
        ...
        msgValidationErrorIcon: '<i class="iconfont icon-tupian"></i> ',
