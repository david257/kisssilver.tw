...
final class GetInfo
{
    ...
    public static function google($token)
    {
        ...
        if (isset($data['id'])) {
            ...
            $userInfo['nickname'] = isset($data['name'])?$data['name']:'';
            $userInfo['avatar'] = isset($data['picture'])?$data['picture']:'';
            $userInfo['openid'] = isset($data['id'])?$data['id']:'';
            $userInfo['given_name'] = isset($data['given_name'])?$data['given_name']:'';
            $userInfo['family_name'] = isset($data['family_name'])?$data['family_name']:'';
            $userInfo['locale'] = isset($data['locale'])?$data['locale']:'';
            $userInfo['email'] = isset($data['email'])?$data['email']:'';
            return $userInfo;
        } else {
    ...
    public static function facebook($token)
    {
        ...
        if (isset($data['id'])) {
            ...
            $userInfo['name'] = isset($data['name'])?$data['name']:'';
            $userInfo['nickname'] = isset($data['name'])?$data['name']:'';
            $userInfo['avatar'] = isset($data['picture']['data']['url'])?$data['picture']['data']['url']:'';
            $userInfo['openid'] = isset($data['id'])?$data['id']:'';
            $userInfo['first_name'] = isset($data['first_name'])?$data['first_name']:'';
            $userInfo['last_name'] = isset($data['last_name'])?$data['last_name']:'';
            $userInfo['short_name'] = isset($data['short_name'])?$data['short_name']:'';
            $userInfo['email'] = isset($data['email'])?$data['email']:'';
            return $userInfo;
        } else {
